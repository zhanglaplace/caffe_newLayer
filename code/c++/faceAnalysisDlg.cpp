	...
	: CDialogEx(CfaceAnalysisDlg::IDD, pParent)
{
	...
	faceImage = Mat(112, 96, CV_8UC3);
	faceDetectThread = new ProcessThread(1, 0, faceImage);
}
...
BEGIN_MESSAGE_MAP(CfaceAnalysisDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CfaceAnalysisDlg::OnBnClickedOk)
...
void CfaceAnalysisDlg::OnBnClickedOk()
{
	// TODO:  在此添加控件通知处理程序代码
	CDialogEx::OnOK();
}
