#ifndef CAFFE_BATCHNORMPLUS_LAYER_HPP_
#define CAFFE_BATCHNORMPLUS_LAYER_HPP_
...
namespace caffe {
	...
	*/
	// 增加了scale层，合并了原始的BN层次
	template <typename Dtype>
	class BatchNormPlusLayer : public Layer<Dtype> {
	public:
		explicit BatchNormPlusLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
		...
		virtual inline const char* type() const { return "BatchNormPlus"; }
	...
	protected:
		...
		Blob<Dtype> mean_, variance_, temp_, x_norm_,x_temp_top;
